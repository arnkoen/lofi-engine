...
/*
    ...
    more scene to fall into place (Audio Worklets implemented everywhere,
...
_SOKOL_PRIVATE void _saudio_aaudio_error_callback(AAudioStream* stream, void* user_data, aaudResult_t error) {
    _SOKOL_UNUSED(stream);
    _SOKOL_UNUSED(user_data);
